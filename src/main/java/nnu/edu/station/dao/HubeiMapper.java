 ...
 *
 * @Author: Yiming
 * @Date: 2023/02/19/20:40
 * @Description:
 */
@Repository
public interface HubeiMapper {
    ...
    List<Map<String, Object>> getDataBeforeTime(@Param("station") String station, @Param("time") String time);
